...
/* harmony import */ var _modules_modals_mask_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/mask.js */ "./js/modules/modals/mask.js");
/* harmony import */ var _modules_modals_mask_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_mask_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_modals_overlay_no_click_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/overlay-no-click.js */ "./js/modules/modals/overlay-no-click.js");
/* harmony import */ var _modules_modals_overlay_no_click_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_overlay_no_click_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_modals_auto_focus__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/auto-focus */ "./js/modules/modals/auto-focus.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_modals_auto_focus__WEBPACK_IMPORTED_MODULE_4__["addAutofocus"])();
  });
});
...
/***/ "./js/modules/modals/auto-focus.js":
/*!*****************************************!*\
  !*** ./js/modules/modals/auto-focus.js ***!
  \*****************************************/
/*! exports provided: addAutofocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addAutofocus", function() { return addAutofocus; });
function addAutofocus() {
  var inputName = document.querySelector('#name_user');
  var buttonOpenModal = document.querySelector('a[data-open-modal="feedback"]');
...
window.addEventListener('DOMContentLoaded', function () {
  [].forEach.call(document.querySelectorAll('input[type="tel"]'), function (input) {
    ...
    function mask(evt) {
      ...
      var val = evt.currentTarget.value.replace(/\D/g, '');
      ...
      var reg = matrix.substr(0, evt.currentTarget.value.length).replace(/_+/g, function (a) {
        return '\\d{1,' + a.length + '}';
      }).replace(/[+()]/g, '\\$&');
      reg = new RegExp('^' + reg + '$');
...
/***/ "./js/modules/modals/overlay-no-click.js":
/*!***********************************************!*\
  !*** ./js/modules/modals/overlay-no-click.js ***!
  \***********************************************/
/*! no static exports found */
...
if (content && overlay) {
  document.addEventListener('click', function (evt) {
    var withinBoundaries = evt.composedPath().includes(content);
    if (!withinBoundaries) {
